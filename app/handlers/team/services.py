...
from app.db.exc import (DatabaseError, TeamsNotExistsError,
                        UniqueTeamNameError, UserNotExistsError)
...
class TeamService:
    ...
    @staticmethod
    async def get_team_by_name(db: BaseAsyncDB, name: str) -> TeamProtocol:
        try:
            team = await db.get_team_by_name(name=name)
            return team
    ...
    async def create_team(
        db: BaseAsyncDB, name: str, addon: EnumAddons, owner_id: str, password: str,
        id: str = Sentinel
    ) -> TeamProtocol:
        try:
        ...
        except (UniqueTeamNameError, UserNotExistsError) as e:
            raise e
    ...
    async def update_team(
        db: BaseAsyncDB, id: str, name: str = Sentinel, addon: EnumAddons = Sentinel,
